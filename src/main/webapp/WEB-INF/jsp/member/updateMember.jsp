		...
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group row">
				...
				<div class="col-sm-4  ">
					...
					<input type="text" id="birthyy" name="birthyy" maxlength="4" placeholder="년(4자)" 	size="6" value="${year}">
					...
					</select> <input type="text" id="birthdd" name="birthdd" maxlength="2" placeholder="일" size="4" value="${day}">
				</div>
			</div>
			<div class="form-group  row ">
				...
				<div class="col-sm-10">
					...
					<select id="mail2" name="mail2" id="mail2">
